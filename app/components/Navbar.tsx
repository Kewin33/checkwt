...
export default function Navbar({selected}: {selected: string}) {
    ...
    return (
        <>
        <div className="shadow-md flex flex-row items-center w-full h-min-48 bg-gray-100 dark:bg-[#0a1a3a] rounded-b-lg border border-gray-300 dark:border-[#1e1e1e] p-4">
