...
export default function highlightJwt(
    ...
    return parts.map((part, index) => {
        const colorClasses = ["text-red-600 dark:text-red-400 decoration-red-500/30", "text-yellow-600 dark:text-yellow-400 decoration-yellow-500/30", "text-green-600 dark:text-green-400 decoration-green-500/30", "text-blue-600 dark:text-blue-400 decoration-blue-500/30", "text-fuchsia-600 dark:text-fuchsia-400 decoration-fuchsia-500/30"];
